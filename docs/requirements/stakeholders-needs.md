...
1. [Характеристика ділових процесів](#Processes)

## Характеристика ділових процесів <a id="Processes"></a>
...
ID: | <span id="FindData">FindData</span>
---|---
НАЗВА: | Знайти дані
УЧАСНИКИ: | Користувач, Система
...
ID: | <span id="SendFeedback">SendFeedback</span>
---|---
...
ID: | <span id="ChangeSourcesList">ChangeSourcesList</span>
---|---
...
ID: | <span id="CreateUserCat">CreateUserCat</span>
---|---
...
ID: | <span id="ChangeUserCatRights">ChangeUserCatRights</span>
---|---
...
ID: | <span id="ChangeCatForUser">ChangeCatForUser</span>
---|---
...
ID: | <span id="DeleteUserCat">DeleteUserCat</span>
---|---
...
ID: | <span id="AddAdmin">AddAdmin</span>
---|---
...
ID: | <span id="UnAdmin">UnAdmin</span>
---|---
